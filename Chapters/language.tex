...
\bnfprod{unordered selection}{
    \bnfts{each} \bnfor
    \bnfts{any} \bnfor % TODO maybe move in aggregates
...
\bnfprod{digit}{
    \bnftd{A single digit [0-9]}
}
\end{bnf*}

% ===== NEW SYNTAX =====

% TODO explain what was ambiguous and all the choices made

\section{Tesla BNF Grammar - New}
% TODO add short intro
...
\bnfprod{assignments}{
    \bnfpn{lower identifier} \bnfsp
    \bnfts{=} \bnfsp
    \bnfpn{assignment expression}
}\\
\bnfprod{assignment expression}{
	% TODO define ...
}
\end{bnf*}

...
Moreover, recently \emph{distributed streams processors} started getting a lot of interest and traction from big tech companies as a new paradigm to handle extremely parallelized and throughput focused stream manipulations, in the same way Hadoop MapReduce \cite{map-reduce} revolutionized batch processing.
